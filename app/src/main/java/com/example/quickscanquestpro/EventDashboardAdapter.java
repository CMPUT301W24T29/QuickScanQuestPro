...
/**
 * Adapter for the EventDashboardFragment
 */
public class EventDashboardAdapter extends ArrayAdapter<Event> implements DatabaseService.OnEventDataLoaded {
     ...
     * @param items
     */
    public EventDashboardAdapter(@NonNull Context context, int resource, List<Event> items) {
    ...
    public void onEventLoaded(Event event) {
        if (event != null) {
            ...
            Log.e("EventDashboardAdapter", "Event is null. Cannot display details.");
